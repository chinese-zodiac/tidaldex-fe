  ...
  return (
    <Grid className='supplymain'>
      ...
      <Flex flexDirection="column">
        ...
        <Text color="#000" marginBottom={1}>{t('Total supply')}</Text>
        {cakeSupply ? (
	   ...
	   <StyledColumn className='box1'>
	   <Flex flexDirection="column">
        <StyledImage className="iconimage" src="/images/home/icon2.png" alt="AmpleSwap" width={64} height={64} /> {t('')}
        <Text color="#000" marginBottom={1}>{t('Circulating supply')}</Text>
        {CirculationBalance ? (
      ...
      <StyledColumn className='box1' noMobileBorder>
        <StyledImage className="iconimage" src="/images/home/icon3.png" alt="AmpleSwap" width={64} height={64} /> {t('')}
        <Text color="#000">{t('Total Burned')}</Text>
        {mcap?.gt(0) && burnedBalance ? (
          <Heading scale="lg"><Balance color='#0097e1' fontSize="24px" bold decimals={0}  value={burnedBalance} /></Heading>
        ) : (
          <Skeleton height={24} width={126} my="4px" />
        )}
      </StyledColumn>
